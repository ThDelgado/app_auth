...
def registro_view(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            borrar_libro = Permission.objects.get(codename='delete_libros', content_type=content_type)
        
            user = form.save() 
            user.user_permissions.add(borrar_libro)
            login(request, user)
